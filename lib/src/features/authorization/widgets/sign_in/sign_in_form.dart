...
class _SignInFormState extends State<SignInForm> {
  ...
  void _validateAndAuth(AuthBloc authBloc) {
                ...
                listener: (BuildContext context, AuthState state) {
                  if (state is AuthError) {
                    SnackBarService.error(
                      context,
                      translation.authorization.error.wrongPasswordOrEmail,
                    );
                  }
                  if (state is AuthSuccessLogin) {
                    context.read<LoggedInState>().emit(state.userData);
                    context.go(
                ...
                builder: (context, state) {
                  return switch (state) {
                    ...
                    _ => FilledButton.tonal(
                        onPressed: () => _validateAndAuth(authBloc),
                        child: Text(
